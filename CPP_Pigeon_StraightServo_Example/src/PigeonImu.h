...
public:
	...
	int Set(ParamEnum paramEnum, double paramValue);
...
private:
	...
	int Set(ParamEnum paramEnum, TareType tareType, double angleDeg);
	int HandleError(int errorCode);
	int ReceiveCAN(int arbId, bool allowStale = true);
